...
<body>
    ...
    <div class="centerize-box">
        <div class="rounded-box" style="width:1200px; display:block; height:auto; margin-bottom:5%; margin-top:0;">
            <h1 class="title-font"> Add New Patient</h1>
                        ...
                        <div style="display:flex; margin-top:10px;">
                            ...
                            <p style="margin-top:10px; padding:0;" class="general-large-font">Personal Information</p>
                                <div style="padding:2%;">
                                    ...
                                    <input id="name" class="form-input" type="name" name="name" value="" required autocomplete="username" default=""/>
                                    
                                </div>

                                <div style="padding:2%;">
                                    <label for="phoneNumber" value="" class="general-font">Phone Number</label>
                                    <input id="phoneNumber" class="form-input" type="phoneNumber" name="phoneNumber" value=""  default=""/>
                                    
                                </div>

                                <div style="padding:2%">
                                    <label for="bloodPressure" value="" class="general-font">Blood Pressure (optional)</label>
                                    <input id="bloodPressure" class="form-input" type="bloodPressure" name="bloodPressure" value=""/>
                                </div>

                                <div style="padding:2%">
                                    <label for="ic" value="" class="general-font">Identification Card Number</label>
                                    <input id="ic" class="form-input" type="ic" name="ic" value="" />
                                </div>
                            </div>
                            <div class="inv-divider" style="width:580px;">
                                ...
                                <div style="padding:2%;">
                                    ...
                                    <input id="email" class="form-input" type="email" name="email" value="" default=""/>
                                    
                                </div>

                                <div style="padding:2%">
                                    <label for="password" value="" class="general-font">Password</label>
                                    <input id="password" class="form-input" type="password" name="password" value=""/>
                                </div>
                            </div> 
