    ...
    <div class="centerize-box">
        <div class="rounded-box">
            <div class="inv-divider" style="margin-right:160px;">
                ...
                <h1 class="title-font">Doctor Login</h1>
            ...
            <div class="inv-divider" style="display: block; margin-top:100px;">
                <form method="POST" action="doctorForm" >
                    @csrf
                    <div style="padding:2%;">
                        <label for="email" value="" class="general-font">Doctor ID</label>
                        <input id="email" class="form-input" type="" name="doctorID" :value="old('email')" required autocomplete="username" />
                    </div>
                    <div style="padding:2%">
                        <label for="password" value="" class="general-font">Password</label>
                        <input id="password" class="form-input" type="password" name="doctorPassword" required autocomplete="new-password" />
                    </div>
